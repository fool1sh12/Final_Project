...
class SelectionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create selection" do
    assert_difference("Selection.count") do
      post selections_url, params: { selection: { add_book: @selection.add_book, book_id: @selection.book_id, user_id: @selection.user_id } }
    end
  ...
  test "should update selection" do
    patch selection_url(@selection), params: { selection: { add_book: @selection.add_book, book_id: @selection.book_id, user_id: @selection.user_id } }
